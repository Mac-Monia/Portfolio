...
export default function Hero() {
  ...
  useEffect(() => {
    const typed = new Typed(typedRef.current, {
      strings: ["Web Development", "3D Modelling", "CyberSecurity", "Embedded Systems"],
      typeSpeed: 75,
      backSpeed: 50,
      loop: true,
    });
      ...
      <div className="grid md:grid-cols-2 gap-10 w-full max-w-6xl">
        ...
        <div className="flex flex-col justify-center gap-5">
          ...
          <h1 className="text-4xl font-bold -mt-3">
            I’m <span className="text-white">Ganza Eliane Mac Monia</span>
          </h1>
          <h2 className="text-3xl">
            I’m into <span className="text-primary" ref={typedRef}></span>
          </h2>
          <p className="text-gray-400 text-xl">
            I’m a Fullstack developer, web & graphic designer, competitive
            programmer, and an open-source enthusiast.
          </p>
          <div className="mt-4">
