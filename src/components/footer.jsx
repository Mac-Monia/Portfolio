  ...
  return (
    <>
      ...
      <footer className="mt-12 bg-[rgb(25,28,32)] flex flex-col md:flex-row gap-6 md:gap-14 items-center justify-center text-white text-sm sm:text-base py-6 px-4 sm:px-8">
        <p className="text-center md:text-left">© 2024 Ganza Monia - All rights reserved</p>
        <div className="flex justify-center space-x-6 sm:space-x-8">
          <a href="https://www.instagram.com/_.m4c.nia._/" target="_blank" className="text-primary hover:text-white">
            <i className="fab fa-instagram fa-lg"></i>
          </a>
          <a href="https://www.linkedin.com/in/ganza-monia-6218092a7" target="_blank" className="text-primary hover:text-white">
            <i className="fab fa-linkedin fa-lg"></i>
          </a>
          <a href="https://www.x.com/mac_monia" target="_blank" className="text-primary hover:text-white">
            <i className="fab fa-x fa-lg"></i>
          </a>
          <a href="https://www.github.com/Mac-Monia" target="_blank" className="text-primary hover:text-white">
